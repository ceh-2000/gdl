...
from graphgps.agg_runs import agg_runs   #MOD
...
from torch_geometric.graphgym.train import train, GraphGymDataModule #MOD
#from torch_geometric.graphgym.utils.agg_runs import agg_runs #NGT uses the funct from graphgps
...
torch.backends.cuda.matmul.allow_tf32 = True  # Default False in PyTorch 1.12+  MOD
torch.backends.cudnn.allow_tf32 = True  # Default True  #MOD
...
if __name__ == '__main__':
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
        ...
        if cfg.train.mode == 'standard':
            ...
            #datamodule = GraphGymDataModule() #POSS 2 MODS TO REPLACE TRAIN(...)
