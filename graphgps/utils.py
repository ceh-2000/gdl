import logging
from typing import List #MOD

import torch
from torch import Tensor  #MOD 
from torch_geometric.utils import degree  #MOD
...
def make_wandb_name(cfg):
    ...
    if cfg.posenc_LapPE.enable:  #MOD
        model_name += "+LapPE"

    if cfg.posenc_RWSE.enable:  #MOD
        model_name += "+RWSE"
